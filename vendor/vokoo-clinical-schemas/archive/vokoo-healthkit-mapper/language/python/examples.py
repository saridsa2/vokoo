"""
Example usage of VoKoo HealthKit Mapper.
"""

from vokoo_healthkit_mapper import HealthKitMapper, HealthKitDataType
...
if __name__ == "__main__":
    print("VoKoo HealthKit Mapper - Examples\n")
    print("=" * 50)
