...
- 📊 Structured output compatible with VoKoo schemas
...
# Or convert directly to VoKoo schema
from vokoo_lab_parser import LabReportParser

parser = LabReportParser()
lab_report = parser.parse_to_vokoo_schema(
...
**parse_to_vokoo_schema(image_path, patient_id)**

Parse and convert to VoKoo LabReport schema.

```python
from vokoo_clinical_schemas.lab_report import LabReport

lab_report: LabReport = parser.parse_to_vokoo_schema(
    "report.jpg",
    "patient-123"
)
```
