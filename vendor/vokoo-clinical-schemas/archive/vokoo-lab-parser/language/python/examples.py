"""
Example usage of VoKoo Lab Parser.
"""
...
def example_vokoo_schema():
    """Example: Parse and convert to VoKoo schema."""
    print("\n=== VoKoo Schema Example ===\n")
    ...
    # Parse to VoKoo LabReport schema
