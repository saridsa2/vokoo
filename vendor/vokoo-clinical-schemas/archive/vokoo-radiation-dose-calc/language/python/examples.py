"""
Example usage of VoKoo Radiation Dose Calculator.
"""

from datetime import datetime, timedelta
from vokoo_radiation_dose_calc import RadiationDoseCalculator, RadiationExposure, ImagingModality
...
if __name__ == "__main__":
    print("VoKoo Radiation Dose Calculator - Examples\n")
    print("=" * 60)
    print()
