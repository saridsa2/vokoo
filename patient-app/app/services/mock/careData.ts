...
const ALL_REQUESTS: OutreachRequest[] = [
  {
    ...
    from: PROVIDER.from,
    because:
      "A fall of a tenth from your usual, holding for two days, is how rejection and infection show themselves first — before you feel unwell.",
  },
  {
    id: "r-2",
    /**
...
export const MILESTONES: Milestone[] = [
  ...
  {
    id: "m-3",
    title: "Your usual was set",
    when: "21 August",
    state: "done",
    detail: "2.35 L, from two tests three weeks apart.",
  },
  {
    id: "m-4",
    title: "Six-week bloods and biopsy",
    when: "Due by 14 September",
    state: "current",
    detail: "The blood test is open now.",
  },
  { id: "m-5", title: "Three-month review", when: "24 October", state: "ahead" },
  { id: "m-6", title: "Six-month review", when: "24 January", state: "ahead" },
]
...
export const RING_IF = [
  ...
  "your morning blow is a tenth below your usual two days running",
]
