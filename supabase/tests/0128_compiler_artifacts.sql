...
begin
  begin
    perform public.materialize_care_path_compilation(
      ...
      '[{"key":"unsafe-flow","name":"Unsafe","trigger_event":"care_path.due","graph":{"nodes":[],"transitions":[]}}]',
      '[]',
