...
interface TabComponentProps extends AriaTabProps {
     ...
     *
     * A ReactNode is rendered as given, so a caller can put a status marker
     * there instead of a count. The Badge wrapper below recolours to brand or
     * gray and hides below `md`, which is right for a count and wrong for a
     * marker that means "something here needs your attention".
     */
            ...
            {(state) => (
                <>
                    ...
                    <span className={cx("flex items-center gap-1.5", type !== "line" && "px-0.5")}>
                        ...
                        {/* Badge — an element is trusted as-is; a count is wrapped. */}
