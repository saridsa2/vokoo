    ...
    return (
        <div className="flex h-dvh flex-col overflow-hidden bg-primary lg:flex-row">
            <SidebarNavigationSectionsSubheadings
                activeUrl={pathname}
                // The console never mentions the platform portal. It is a
                // different product at a different address, and an operator
                // reaches it by going there rather than by finding a menu item
                // inside a workspace.
                items={NAV_SECTIONS}
