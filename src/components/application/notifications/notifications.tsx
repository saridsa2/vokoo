...
// Rewritten from `@untitledui/icons` — this console is Font Awesome duotone
// throughout, and `@/components/icons` is the single place that decides the
// icon set, style and duotone opacities. See CLAUDE.md.
import { AlertCircle, CheckCircle, InfoCircle } from "@/components/icons";
